...
const UserDetail = ({apiData}) => {
    ...
    details.push(["name", detail.name])
    details.push(["season", detail.season])
    details.push(["number", detail.number])
    details.push(["airdate", detail.airdate])
    details.push(["runtime", detail.runtime])
    details.push(["airstamp", detail.airstamp])
